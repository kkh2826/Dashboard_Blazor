...
GO
:setvar DatabaseName "UploadApp"
:setvar DefaultFilePrefix "UploadApp"
...
GO
PRINT N'테이블 [dbo].[Uploads]을(를) 만드는 중...';
...
GO
PRINT N'DEFAULT 제약 조건 [dbo].[Uploads]에 대한 명명되지 않은 제약 조건을(를) 만드는 중...';
